...
public class to_be_attended extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_to_be_attended );
        requestQueue= Volley.newRequestQueue( this );
        progressBar=findViewById( R.id.to_be_attended_progressbar );
        recyclerView=findViewById( R.id.to_be_attended_recycler_view );
    ...
    void requestdata(){
        ...
        final String url="https://unreaving-power.000webhostapp.com/toAttend.php";
            ...
            public void onResponse(JSONObject response) {
                try {
                    if(response.getInt( "success" )==0){
                        Toast.makeText( to_be_attended.this,"Some error occured",Toast.LENGTH_LONG ).show();
                    }
                    else
                    {
                        ...
                        toBeAttendedRecycler toBeAttendedRecycler= new toBeAttendedRecycler(list,to_be_attended.this);
                        recyclerView.setHasFixedSize(true);
                        recyclerView.setLayoutManager(new LinearLayoutManager(to_be_attended.this));
